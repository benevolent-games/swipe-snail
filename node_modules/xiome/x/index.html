...
<div class="page content">
	...
	<div class="segment twoside">
		<div class="text">
			...
			<ol>
				<li>create your community on the <a href="./setup">setup page</a> and connect your website</li>
				<li>browse for plugins on the <a href="./components">components page</a> to copy-paste</li>
			</ol>
		</div>
		<div class="art">
			<!-- akar icons "copy" -->
