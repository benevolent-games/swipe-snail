        ...
        render() {
			...
			`,
				...
				<slot name=loading>
					${this.loadingIcon}
					${this["loading-message"]
                ? y `<span>${this["loading-message"]}</span>`
                : null}
				</slot>
			`,
                error: reason => y `
                ...
                ? null
                : y `<span>${reason !== null && reason !== void 0 ? reason : this["error-message"]}</span>`}
...
`;
    ...
    var checkSvg = w `<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="feather feather-check"><polyline points="20 6 9 17 4 12"></polyline></svg>`;
    ...
    let XioCheckbox = class XioCheckbox extends Component {
        ...
        render() {
            ...
            none: () => null,
            loading: () => spinnerIcon,
            error: reason => y `${warningSvg}<div class=error>${reason}</div>`,
...
`;
    ...
    var svgCircleCheck = w `<svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="feather feather-check-circle"><path d="M22 11.08V12a10 10 0 11-5.93-9.14"/><path d="M22 4L12 14.01l-3-3"/></svg>`;
...
`;
    ...
    var chevronUpSvg = w `<svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="feather feather-chevron-up"><polyline points="18 15 12 9 6 15"></polyline></svg>`;

    var chevronDownSvg = w `<svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="feather feather-chevron-down"><polyline points="6 9 12 15 18 9"></polyline></svg>`;
    ...
    _XioPriceInput_focusInputParent = new WeakMap(), _XioPriceInput_unfocusInputParent = new WeakMap(), _XioPriceInput_resizeInput = new WeakMap(), _XioPriceInput_validateInput = new WeakMap(), _XioPriceInput_handleInputChange = new WeakMap(), _XioPriceInput_instances = new WeakSet(), _XioPriceInput_handleButtonClick = function _XioPriceInput_handleButtonClick(type) {
...
`;
    ...
    var sunSvg = w `<svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="feather feather-sun"><circle cx="12" cy="12" r="5"></circle><line x1="12" y1="1" x2="12" y2="3"></line><line x1="12" y1="21" x2="12" y2="23"></line><line x1="4.22" y1="4.22" x2="5.64" y2="5.64"></line><line x1="18.36" y1="18.36" x2="19.78" y2="19.78"></line><line x1="1" y1="12" x2="3" y2="12"></line><line x1="21" y1="12" x2="23" y2="12"></line><line x1="4.22" y1="19.78" x2="5.64" y2="18.36"></line><line x1="18.36" y1="5.64" x2="19.78" y2="4.22"></line></svg>`;

    var moonSvg = w `<svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="feather feather-moon"><path d="M21 12.79A9 9 0 1 1 11.21 3 7 7 0 0 0 21 12.79z"></path></svg>`;
...
`;
    ...
    let XioProfileCard = class XioProfileCard extends Component {
        ...
        render() {
            ...
            return renderOp(__classPrivateFieldGet$f(this, _XioProfileCard_state, "f").readable.busy, () => y `
...
`;
    ...
    _XioPriceDisplay_renderWhenSuperscriptIsDisabled = new WeakMap(), _XioPriceDisplay_renderWhenSupercriptIsEnabled = new WeakMap(), _XioPriceDisplay_instances = new WeakSet(), _XioPriceDisplay_leftPadCents = function _XioPriceDisplay_leftPadCents(cents) {
...
`;
    ...
    function renderXiomeConfig(appId) {
        const h = (syntax, s) => y `<span data-syntax=${syntax}>${s}</span>`;
        const tag = (s) => h("tag", s);
    ...
    function makeAppForm({ clearOnSubmit, submitButtonText, showAdditionalOrigins, initialValues = getEmptyAppFormDraft(), query, submit, requestUpdate, }) {
		...
		`;
            const renderTextInput = ({ hide, textarea, label, dataForm, initialText, showValidationWhenEmpty, parser, validator, }) => y `
			<xio-text-input
				?textarea=${textarea}
    ...
    function makeAdminManager({ app, appEditService, query }) {
        ...
        function renderAdminList() {
            return y `
			<div class=adminlist>
				${renderOp(state.admins, admins => y `
					<ul>
						${admins.map(({ email, userId }) => y `
							<li>
								<span>${email}</span>
...
`;
    ...
    let XiomeMyAccount = class XiomeMyAccount extends mixinRequireShare()(Component) {
        ...
        render() {
            ...
            return renderOp(accessOp, ({ user }) => y `
			<xio-profile-card
				show-details
				.user=${user}
...
`;
    ...
    let XiomePrivileges = class XiomePrivileges extends mixinRequireShare()(Component) {
        ...
        render() {
            ...
            return renderOp(permissionsDisplay, permissions => allowed ? y `
    ...
    _XiomePrivileges_busy = new WeakMap(), _XiomePrivileges_labelDraft = new WeakMap(), _XiomePrivileges_handleCreatorLabelChange = new WeakMap(), _XiomePrivileges_instances = new WeakSet(), _XiomePrivileges_clearCreatorTextInput = function _XiomePrivileges_clearCreatorTextInput() {
        ...
        const confirm = await this.share.modals.confirm({
            title: y `delete privilege ${label}?`,
            body: y `are you sure you want to delete this privilege?`,
        });
        if (confirm)
...
`;
    ...
    var lockSvg = w `<svg xmlns="http://www.w3.org/2000/svg" width="1em" height="1em" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="feather feather-lock"><rect x="3" y="11" width="18" height="11" rx="2" ry="2"></rect><path d="M7 11V7a5 5 0 0 1 10 0v4"></path></svg>`;
        ...
        renderPrivilege({ privilegeId, label, hard, immutable, onPrivilegeClick, }) {
			...
			<xio-button
				...
				@press=${onPrivilegeClick}>
					<div>
						${hard
            ? y `<div class=icon>${wrenchSvg}</div>`
            : null}
						${immutable
            ? y `<div class=icon>${lockSvg}</div>`
            : null}
						${label}
					</div>
			</xio-button>
    ...
    var usersSvg = w `<svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="feather feather-users"><path d="M17 21v-2a4 4 0 0 0-4-4H5a4 4 0 0 0-4 4v2"></path><circle cx="9" cy="7" r="4"></circle><path d="M23 21v-2a4 4 0 0 0-3-3.87"></path><path d="M16 3.13a4 4 0 0 1 0 7.75"></path></svg>`;
...
<svg xmlns="http://www.w3.org/2000/svg" width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="feather feather-volume-x"><polygon points="11 5 6 9 2 9 2 15 6 15 11 19 11 5"></polygon><line x1="23" y1="9" x2="17" y2="15"></line><line x1="17" y1="9" x2="23" y2="15"></line></svg>`;
    ...
    var deleteIcon = w `<svg xmlns="http://www.w3.org/2000/svg" width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="feather feather-x-circle"><circle cx="12" cy="12" r="10"></circle><line x1="15" y1="9" x2="9" y2="15"></line><line x1="9" y1="9" x2="15" y2="15"></line></svg>`;
    ...
    _XiomeChat_room = new WeakMap(), _XiomeChat_dispose = new WeakMap(), _XiomeChat_scrolledToBottom = new WeakMap(), _XiomeChat_coordinateScrollingBehavior = new WeakMap(), _XiomeChat_lastSend = new WeakMap(), _XiomeChat_updateTooSoon = new WeakMap(), _XiomeChat_postToChat = new WeakMap(), _XiomeChat_instances = new WeakSet(), _XiomeChat_model_get = function _XiomeChat_model_get() {
        ...
        const authorshipArea = () => {
            return __classPrivateFieldGet$c(this, _XiomeChat_room, "f").weAreBanned
                ? y `<slot name=banned>you are banned</slot>`
                : __classPrivateFieldGet$c(this, _XiomeChat_room, "f").weAreMuted
                    ? y `<slot name=muted>you are muted</slot>`
        ...
        return y `
			<xiome-login-panel>
				${whenOpReady(__classPrivateFieldGet$c(this, _XiomeChat_instances, "a", _XiomeChat_model_get).state.accessOp, () => y `
...
`;
    ...
    var chevronLeft = w `<svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="feather feather-chevron-left"><polyline points="15 18 9 12 15 6"></polyline></svg>`;

    var chevronRight = w `<svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="feather feather-chevron-right"><polyline points="9 18 15 12 9 6"></polyline></svg>`;

    var plus = w `<svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="feather feather-plus"><line x1="12" y1="5" x2="12" y2="19"></line><line x1="5" y1="12" x2="19" y2="12"></line></svg>`;

    var crossSvg = w `<svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="feather feather-x"><line x1="18" y1="6" x2="6" y2="18"></line><line x1="6" y1="6" x2="18" y2="18"></line></svg>`;
    ...
    _XiomeNotes_model = new WeakMap(), _XiomeNotes_cacheDetails = new WeakMap(), _XiomeNotes_cache = new WeakMap(), _XiomeNotes_instances = new WeakSet(), _XiomeNotes_renderTabs = function _XiomeNotes_renderTabs() {
        ...
        const now = Date.now();
        return renderOp(notesOp, notes => y `
			<ol>
				${notes.map(note => y `
					<li>
...
`;
    ...
    var bell = w `<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="feather feather-bell"><path d="M18 8A6 6 0 0 0 6 8c0 7-3 9-3 9h18s-3-2-3-9"></path><path d="M13.73 21a2 2 0 0 1-3.46 0"></path></svg>`;
    ...
    let XiomeNotesIndicator = class XiomeNotesIndicator extends mixinRequireShare()(Component) {
        ...
        render() {
            const bellSpan = y `<span class="bell">${bell}</span>`;
            const { stats } = this.share.notesModel;
            return y `
				${stats.newCount === 0 ? y `${bellSpan}`
            : y `
...
`;
    ...
    let XiomeVideoViews = class XiomeVideoViews extends mixinRequireShare()(Component) {
        ...
        render() {
            ...
            return model.allowance.canModerateVideos
                ? renderOp(model.state.viewsOp, views => y `
				<slot>
    ...
    var clockIcon = w `<svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="feather feather-clock"><circle cx="12" cy="12" r="10"></circle><polyline points="12 6 12 12 16 14"></polyline></svg>`;
    ...
    let XiomeVideoHosting = class XiomeVideoHosting extends mixinRequireShare()(Component) {
		...
		`;
			...
			${__classPrivateFieldGet$a(this, _XiomeVideoHosting_linkFailed, "f")
                ? y `<div class=failed>${warningSvg} <p>dacast rejected the api link</p></div>`
                : null}
			<div class=buttonbar>
				<xio-button
					class=help-button
        ...
        render() {
            return renderOp(this.state.accessOp, access => y `
			<div class=dacastbox>
            ...
            : y `<slot name=forbidden>you don't have permission to edit video hosting settings</slot>`}
			</div>
		`);
        }
    };
...
`;
    ...
    function renderViewCreator({ isContentSelected, isCreateButtonDisabled, privilegesOp, catalogOp, selectedContent, queryAll, onCatalogSelect, onPrivilegesSelect, onCreateClick, isPrivilegeSelected, }) {
        ...
        function renderContentSelector() {
            ...
            : y `
							...
							`}
						${catalog.map(({ provider, type, title }, index) => y `
        ...
        return renderOp(ops.combine(catalogOp, privilegesOp), () => y `
    ...
    let XiomeVideoDisplay = class XiomeVideoDisplay extends mixinRequireShare()(Component) {
        ...
        render() {
            return renderOp(__classPrivateFieldGet$9(this, _XiomeVideoDisplay_instances, "a", _XiomeVideoDisplay_model_get).state.accessOp, () => y `
    ...
    _XiomeVideoDisplay_embeds = new WeakMap(), _XiomeVideoDisplay_videoControls = new WeakMap(), _XiomeVideoDisplay_instances = new WeakSet(), _XiomeVideoDisplay_model_get = function _XiomeVideoDisplay_model_get() {
        ...
        return show
            ? show.details
                ? y `
					${this["show-title"]
                ? y `<h4 part=title>${show.details.title}</h4>`
                : null}
					${(_a = __classPrivateFieldGet$9(this, _XiomeVideoDisplay_embeds, "f")
                .obtain(show.details, this["mock-embed"])) !== null && _a !== void 0 ? _a : "(embed missing)"}
					<slot></slot>
				`
                : y `<slot name=unprivileged></slot>`
            : y `<slot name=unavailable></slot>`;
    };
    __decorate$7([
        e({ type: String })
...
`;
    ...
    let XiomeExample = class XiomeExample extends mixinRequireShare()(Component) {
        ...
        render() {
            ...
            ? y `<p>Welcome, ${access.user.profile.nickname}</p>`
            : y `<p>User is not logged in.</p>`}
		`);
        }
    };
        ...
        switch (specificOptions.type) {
            case PostType.Question: {
				...
				`,
					...
					${deletePost
                    ? y `<a href="#" @click=${linkClick(deletePost)}>delete</a>`
                    : null}
					${toggleAnswerEditor
                    ? y `<a href="#" @click=${linkClick(toggleAnswerEditor)}>answer</a>`
                    : null}
				`,
                    buttonBar: undefined,
                });
    ...
    let XiomeQuestions = class XiomeQuestions extends mixinTicker(1000)(mixinRequireShare()(Component)) {
        ...
        renderQuestionsBoard() {
            ...
            ? y `
				...
				`
            : y `<slot name=empty><p>Be the first to post a question!</p></slot>`}
		`);
        }
        render() {
    ...
    class XiomeStoreConnect extends mixinRequireShare()(Component) {
        ...
        renderStripeConnectControls() {
            ...
            return renderOp(connectStatusOp, status => {
                ...
                switch (status) {
                    case StripeConnectStatus.Unlinked: return y `
					<p>status: unlinked</p>
					<xio-button @press=${stripeAccountOnboarding}>
						Onboard Stripe Account
					</xio-button>
				`;
                    case StripeConnectStatus.Incomplete: return y `
					<p>status: incomplete</p>
					${renderStripeAccountDetailsReadout()}
					${renderLoginAndSetupButton()}
				`;
                    case StripeConnectStatus.Paused: return y `
					<p>status: paused</p>
					${renderStripeAccountDetailsReadout()}
					${renderLoginAndSetupButton()}
				`;
        ...
        render() {
            ...
            : y `<p>your account is not allowed to control the linked stripe account</p>`}
		`;
        }
    }
...
`;
    ...
    _XiomeStoreBillingArea_instances = new WeakSet(), _XiomeStoreBillingArea_state_get = function _XiomeStoreBillingArea_state_get() {
    ...
    _XiomeStoreCustomerPortal_openPopup = new WeakMap(), _XiomeStoreCustomerPortal_instances = new WeakSet(), _XiomeStoreCustomerPortal_storeModel_get = function _XiomeStoreCustomerPortal_storeModel_get() {
        return this.share.storeModel;
...
`;
    ...
    const XiomeStoreSubscriptionTier = component({
        ...
        ? y `<span part=tier_status>${statusLabel}</span>`
        : undefined}
			${interactivity
        ? renderButton()
        : undefined}
    ...
    function getOngoingSubscriptions(storeModel) {
        var _a;
        return ((_a = storeModel
            .get
            .subscriptions
            .mySubscriptionDetails) !== null && _a !== void 0 ? _a : [])
            .map(subscription => {
            const plan = (storeModel
                .get
                .subscriptions
                .plans
...
`;
    ...
    const XiomeStoreSubscriptionStatus = ({ storeModel }) => component({
        ...
        return renderOp(op, () => y `
		<div data-card-list>
			${getOngoingSubscriptions(storeModel).map(basics => y `
				<div data-card>
    ...
    function preparePurchaseActions({ modals, button, tier, storeModel }) {
    ...
    function ascertainTierInteractivity({ basics: { tier }, context: { subscription, status, tierIndex, subscribedTierIndex, isAnotherTierInPlanUnpaid, }, modals, storeModel, setOp, }) {
        const { tierId } = tier;
    ...
    function renderTier(params, plan, tier) {
        const { slots, modals, storeModel, setOp, } = params;
...
[data-plan-label] {
    ...
    const XiomeStoreSubscriptionCatalog = ({ modals, storeModel }) => component({
        ...
        return renderOp(ops.combine(op, storeModel.state.subscriptions.subscriptionPlansOp, storeModel.state.subscriptions.mySubscriptionDetailsOp), () => y `
			<ol data-plans>
        ...
        function renderTier(plan, tier) {
            ...
            : null}
					...
					` : y `
						...
						${hasPricing
            ? y `<p>price: $${centsToDollars(tier.pricing[0].price)}</p>`
            : y `<p style="color: red">price not set</p>`}
    ...
    let XiomeStoreSubscriptionPlanning = class XiomeStoreSubscriptionPlanning extends mixinRequireShare()(Component) {
        ...
        render() {
            ...
            ? allowance.manageStore
                ...
                : y `<p>your account does not have permissions to manage the store</p>`
            : y `<p>store is not active</p>`}
		`;
        }
    };
    _XiomeStoreSubscriptionPlanning_componentSnap = new WeakMap(), _XiomeStoreSubscriptionPlanning_planningUi = new WeakMap(), _XiomeStoreSubscriptionPlanning_instances = new WeakSet(), _XiomeStoreSubscriptionPlanning_storeModel_get = function _XiomeStoreSubscriptionPlanning_storeModel_get() { return this.share.storeModel; };
        ...
        return async ({ title, input, body = null, yes = { label: "okay", vibe: "positive" }, no = { label: "nevermind", vibe: "neutral" }, focusNthElement = 1, blanketClickMeansCancel = true, }) => new Promise(resolve => {
            ...
            const { controls, modal } = popup({
                ...
                renderContent: controls => {
                    ...
                    return y `
					<div data-confirm>
						${typeof title == "string" ? y `<h2>${title}</h2>` : title}
						${typeof body == "string" ? y `<p>${body}</p>` : body}
						${xioTextInput}
						<div data-buttons>
							<xio-button
								data-button=yes
